    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
            <div class="thumbnail">
                <div class="caption">
                  <h3>Question Manage</h3>
                  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                  <p><a href="/action/questionAction.php?action=queryall" class="btn btn-default" role="button">Detail</a></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="thumbnail">
                <div class="caption">
                  <h3>Test View</h3>
                  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                  <p><a href="/action/testAction.php?action=queryall" class="btn btn-default" role="button">Detail</a></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
